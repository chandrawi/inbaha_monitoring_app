export default function TitleMenuIndex() {
  return (
    ...
    <div class="dropdown h-full static sm:relative">
      <div class="w-full h-full overflow-hidden wrap-break-word">
        <button tabindex="0" class="group h-full pl-3 pr-2.5 flex flex-row items-center justify-center md:justify-start hover:text-sky-800 sm:border-x border-slate-200 dark:hover:text-sky-300 dark:border-slate-700">
          ...
          <h1 class="h-full leading-14 ml-1 mr-0.5 xs:ml-2 xs:mr-1 font-medium text-lg">Monitoring</h1>
    ...
    <div class="dropdown h-full static sm:relative">
      <div class="w-full h-full overflow-hidden wrap-break-word">
        <button tabindex="0" class="group h-full pl-3 pr-2.5 hidden sm:flex flex-row items-center hover:text-sky-800 border-r border-slate-200 dark:hover:text-sky-300 dark:border-slate-700">
          ...
          <h1 class="h-full leading-14 ml-1 mr-0.5 xs:ml-2 xs:mr-1 font-medium text-lg">Category</h1>
          <span class="icon-arrow_fill_down text-[1rem] text-sky-700"></span>
        </button>
      </div>
      <div class="w-full sm:w-auto flex flex-row wrap-break-word">
        <div class="dropdown-content w-60 bg-white shadow-md-res shadow-slate-200 rounded-b-sm dark:bg-gray-800 dark:shadow-slate-950">
    ...
    <div class="dropdown h-full static sm:relative">
      <div class="w-full h-full overflow-hidden wrap-break-word">
        <button tabindex="0" class="group h-full pl-3 pr-2.5 hidden sm:flex flex-row items-center hover:text-sky-800 border-r border-slate-200 dark:hover:text-sky-300 dark:border-slate-700">
          ...
          <h1 class="h-full leading-14 ml-1 mr-0.5 xs:ml-2 xs:mr-1 font-medium text-lg">Region</h1>
          <span class="icon-arrow_fill_down text-[1rem] text-sky-700"></span>
        </button>
      </div>
      <div class="w-full sm:w-auto flex flex-row justify-end lg:justify-start wrap-break-word">
        <div class="dropdown-content w-60 bg-white shadow-md-res shadow-slate-200 rounded-b-sm dark:bg-gray-800 dark:shadow-slate-950">
